---
id: doc://docs/development/ds-index005-semantic-plain-failure.md
...
Failed stage: `workflow policy (exit 1)`.
...
OK
===== workflow policy =====
error: .github/workflows/ci.yml: unreviewed write permissions: ['contents']
```
