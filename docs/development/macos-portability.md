...
These branch-only sentences trigger pull-request observations of the already-published signal and are
not intended for merge. The second commit specifically exercises the `synchronize` event.
