...
- `dartscope-index` performs project-level linking over normalized analysis results. A shared
  ...
  compound-assignment and increment accesses, supported closure/loop/catch scopes, legal
  earlier-to-later local-declaration accesses, and existing-variable `for-in` writes, through
