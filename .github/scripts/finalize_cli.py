...
plan = Path("docs/development/dartscope-library-plan.md")
text = plan.read_text()
old = textwrap.dedent(
    """
...
old_parse = "Status: planned. Priority: P1. Prerequisite: DS-PARSE-005.\n\nAdd normalized methods,"
new_parse = "Status: ready. Priority: P1. Prerequisite: DS-PARSE-005.\n\nAdd normalized methods,"
assert text.count(old_parse) == 1
...
for old_value, new_value in replacements:
    assert text.count(old_value) == 1, old_value
